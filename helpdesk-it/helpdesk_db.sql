...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2025 at 06:33 AM
...
CREATE TABLE `laporan` (
  ...
  `kategori` enum('Komputer','Printer','Jaringan','Software','Lainnya') NOT NULL,
  `masalah` varchar(150) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('karyawan','teknisi') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
